...
function getUserPoolRegion(userPoolId) {
...
async function provisionCompanyUser(userPoolId, email, temporaryPassword) {
...
async function addUserToCompanyGroup(cognito, userPoolId, email) {
    try {
